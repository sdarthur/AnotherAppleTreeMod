...
public class AATMBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.add(AATMBlocks.APPLE_FRUIT_LEAVES.get(), LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        .add(LootItem.lootTableItem(AATMBlocks.APPLE_LEAVES.get())
                                .when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(AATMBlocks.APPLE_FRUIT_LEAVES.get())
